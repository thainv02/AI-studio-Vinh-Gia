...
import { UploadIcon, VideoIcon, TrashIcon } from './icons';
...
export const VideoUpload: React.FC<VideoUploadProps> = ({ onUpload, onReset, currentFile }) => {
        ...
        return (
            <div className="bg-gray-700/50 p-4 rounded-lg flex items-center justify-between">
                <div className="flex items-center space-x-3 truncate">
                    <VideoIcon className="h-6 w-6 text-indigo-400 flex-shrink-0" />
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full">
            ...
            >
                ...
                <input id="video-input" type="file" accept="video/*" className="hidden" onChange={onFileChange} />
